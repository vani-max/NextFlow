...
} from "../../../../../../../../chunk-XFKKCBPB.mjs";
import "../../../../../../../../chunk-6L3DBTMP.mjs";
import "../../../../../../../../chunk-YWPWLCTP.mjs";
import {
  __commonJS,
  __export,
  __name,
...
var makePrettyError = /* @__PURE__ */ __name((originalError) => {
  ...
  const error2 = new Error(prettyErrorMessage(originalError), originalErrorIsObject && "cause" in originalError && typeof originalError.cause !== "undefined" ? {
  ...
  Error.stackTraceLimit = prevLimit;
  error2.name = originalError instanceof Error ? originalError.name : "Error";
  if (originalErrorIsObject) {
    if (spanSymbol in originalError) {
      error2.span = originalError[spanSymbol];
    }
    Object.keys(originalError).forEach((key) => {
      if (!(key in error2)) {
        error2[key] = originalError[key];
      }
    });
  }
  error2.stack = prettyErrorStack(`${error2.name}: ${error2.message}`, originalError instanceof Error && originalError.stack ? originalError.stack : "", error2.span);
  return error2;
}, "makePrettyError");
...
// ../../.npm/_npx/f51a09bd0abf5f10/node_modules/effect/dist/esm/internal/core-effect.js
init_esm();
...
// ../../.npm/_npx/f51a09bd0abf5f10/node_modules/effect/dist/esm/JSONSchema.js
var make30 = /* @__PURE__ */ __name((schema, options) => {
  const definitions = {};
...
__name(getMetaSchemaUri, "getMetaSchemaUri");
...
function encodeExamples(ast, examples) {
  const getOption4 = getOption3(ast, false);
  const out = filterMap2(examples, (e) => getOption4(e).pipe(filter(isJsonValue)));
...
function isJsonValue(value, visited = /* @__PURE__ */ new Set()) {
  ...
  if (Array.isArray(value) || typeof value === "object") {
    ...
    try {
      ...
      if (proto3 !== null && proto3 !== Object.prototype) {
        return false;
      }
...
function pruneJsonSchemaAnnotations(ast, description, title, def, examples) {
  ...
  if (isSome2(def)) {
    ...
    if (isSome2(o2) && isJsonValue(o2.value)) {
...
var mergeRefinements = /* @__PURE__ */ __name((from, jsonSchema, ast) => {
  ...
  out.allOf ??= [];
  const handle = /* @__PURE__ */ __name((name, filter7) => {
    if (name in jsonSchema && name in from) {
      out.allOf.unshift({
        [name]: from[name]
      });
      out.allOf = out.allOf.filter(filter7);
    }
  }, "handle");
              ...
              if (isRecord(toProperty)) {
                ...
                if (isRecord(fromProperty)) {
                  ...
                  if (Object.hasOwn(toProperty, "default") && toProperty.default !== void 0) {
                    annotations2.default = toProperty.default;
                  }
...
__name(convertPromptSchemasToJsonSchemas, "convertPromptSchemasToJsonSchemas");
